...
This repo is the working code built and iterated during the competition: strategies, the research that calibrated them, the manual-challenge solvers, and the harness used to A/B test variants before submission.
